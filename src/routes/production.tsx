...
import { ArrowLeft, Boxes, CalendarDays, Factory, Search } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-gray-500 mb-8 max-w-3xl">
          The uploaded production schedule as it stands, grouped by production
          date. Quantities are cases, exactly as the export gives them.
        </p>
